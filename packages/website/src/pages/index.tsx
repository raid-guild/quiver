...
//             <div className="px-4 bg-slate-700 text-slate-50">
//                 <h1 className="text-3xl font-bold">Waddupbitch</h1>
//             </div>
//             <HomepageHeader />
//             <main>
//                 <HomepageFeatures />
...
const Home: React.FC = () => {
    return (
        <div className="bg-zinc-900 min-h-screen bg-arrow-bg bg-left bg-cover bg-no-repeat">
            <div className="p-8 sm:pl-44 pt-20 sm:pt-56 font-mono max-w-lg sm:max-w-4xl">
                ...
                <div className="flex flex-col space-y-12">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-2 sm:space-x-3">
                        <button className="flex justify-center space-x-3 text-white bg-gradient-to-r from-raidRed to-raidPurple p-2 rounded-sm">
                            <span>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6"
